...
- Каркас автоматических тестов:
  ...
  - Переиспользуемый workflow `.github/workflows/setup-python.yml` для настройки Python окружения с кешированием pip зависимостей.
- Фикстуры `pytest`:
...
- Workflow CI/CD переработан:
  - Создан переиспользуемый workflow `setup-python.yml` для единообразной настройки Python окружения с кешированием pip зависимостей.
